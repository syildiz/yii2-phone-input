...
```bash
$ php composer.phar require "syildiz/yii2-phone-input" "*"
```

or add

```
"syildiz/yii2-phone-input": "*"
```
...
```php
use syildiz\extensions\phoneInput\PhoneInput;
...
use syildiz\extensions\phoneInput\PhoneInputValidator;
...
use syildiz\extensions\phoneInput\PhoneInputBehavior;
